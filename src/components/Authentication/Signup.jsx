  ...
  const handleUploadPicture = async (e) => {
    ...
    if (
      ...
      try {
        ...
        data.append("upload_preset", "ml_default"); // Upload preset in Cloudinary
        data.append("cloud_name", "dualh5g6b"); // Cloud name in Cloudinary

        const response = await fetch(
          "https://api.cloudinary.com/v1_1/dualh5g6b/image/upload",
          {
            method: "POST",
            body: data,
          }
